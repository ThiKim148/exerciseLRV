    ...
    <div id="content" class="space-top-none">												
        <div class="main-content">												
            ...
            <div class="row">												
                ...
                <div class="col-sm-9">												
                    <div class="beta-products-list">	<br>												
                                ...
                                <div class="col-sm-4">												
                                    <div class="single-item">												
                                        <div class="single-item-header">												
                                            <a href="detail/{{$sp->id}}"><img width="200" height="200" src="/source/assets/image/product/{{$sp->image}}" alt=""></a>												
                                        </div>												
                        ...
                        <div class="row">												
                            @foreach($sp_khac as $khac)												
                                <div class="col-sm-3">												
                                    <div class="single-item">												
                                        <div class="single-item-header">												
                                            <a href=""><img width="200" height="200" src="/source/assets/image/product/{{$khac->image}}" alt=""></a>												
                                        </div>												
